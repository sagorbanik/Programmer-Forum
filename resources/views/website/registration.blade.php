...
<head>
    ...
    <!-- Font Icon -->
    <link rel="stylesheet" href="{{asset('contents/website')}}/fonts/material-icon/css/material-design-iconic-font.min.css">
...
<body>
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title col-md-12">Sign up</h2>
                        <form method="POST" action="{{ route('new.register') }}">
                            @csrf
                            <div class="form-group row">
                                <label for="name" class="col-md-6 col-form-label text-md-right" placeholder="Name">{{ __('Name') }}</label>
                                <div class="col-md-6">
                    ...
                    <div class="signup-image">
                        <figure><img src="{{asset('contents/website')}}/images/signup-image.jpg" alt="sing up image"></figure>
                        <a href="{{url('new/user/login')}}" class="signup-image-link">I am already member</a>
                    </div>
                </div>
            </div>
        </section>
    ...
    <!-- JS -->
    <script src="{{asset('contents/website')}}/vendor/jquery/jquery.min.js"></script>
</body>
</html>
